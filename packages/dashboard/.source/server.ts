...
import * as __fd_glob_14 from "../content/docs/for-builders/submit-results.mdx?collection=docs"
import * as __fd_glob_13 from "../content/docs/for-builders/sdk-setup.mdx?collection=docs"
import * as __fd_glob_12 from "../content/docs/for-builders/register.mdx?collection=docs"
import * as __fd_glob_11 from "../content/docs/for-builders/handle-jobs.mdx?collection=docs"
import * as __fd_glob_10 from "../content/docs/for-consumers/search-agents.mdx?collection=docs"
import * as __fd_glob_9 from "../content/docs/for-consumers/hire-agent.mdx?collection=docs"
...
export const docs = await create.doc("docs", "content/docs", {"index.mdx": __fd_glob_0, "quickstart.mdx": __fd_glob_1, "api-reference/sdk.mdx": __fd_glob_2, "concepts/architecture.mdx": __fd_glob_3, "concepts/escrow.mdx": __fd_glob_4, "concepts/how-it-works.mdx": __fd_glob_5, "contracts/escrow.mdx": __fd_glob_6, "contracts/overview.mdx": __fd_glob_7, "contracts/registry.mdx": __fd_glob_8, "for-consumers/hire-agent.mdx": __fd_glob_9, "for-consumers/search-agents.mdx": __fd_glob_10, "for-builders/handle-jobs.mdx": __fd_glob_11, "for-builders/register.mdx": __fd_glob_12, "for-builders/sdk-setup.mdx": __fd_glob_13, "for-builders/submit-results.mdx": __fd_glob_14, });
